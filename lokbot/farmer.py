...
Status - {status}{occupied_info}"""
                    ...
                    if config.get('discord', {}).get('enabled', False):
                        try:
                            ...
                            is_occupied = "Occupied" in status
                            ...
                            if code == 20100105 and level >= 2 and not is_occupied and config.get('discord', {}).get('level2plus_webhook_url'):
                            ...
                            if level >= 2 and is_occupied and config.get('discord', {}).get('occupied_resources_webhook_url'):
                                occupied_webhook = DiscordWebhook(config.get('discord', {}).get('occupied_resources_webhook_url'))
